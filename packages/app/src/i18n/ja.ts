export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TestAgent Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "settings.updates.row.startup.description": "TestAgent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "TestAgent は最新バージョンです。",
