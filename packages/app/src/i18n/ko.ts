export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "TestAgent Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "dialog.server.description": "이 앱이 연결할 TestAgent 서버를 전환합니다.",
  ...
  "error.page.report.prefix": "이 오류를 TestAgent 팀에 제보해 주세요: ",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 TestAgent 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "TestAgent 표시 언어 변경",
  ...
  "settings.general.row.theme.description": "TestAgent 테마 사용자 지정",
